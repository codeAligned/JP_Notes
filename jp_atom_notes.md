...
Foremost is the ability to use _multiple cursors_ at a time!  To do this, simply hold down __Command__ (__Alt__ on Windows, I believe) and click where you want additional cursors to be.  This allows multi-line, multi-point editing.  Depending on the file, this can be an unrivaled convenience.
